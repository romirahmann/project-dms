  ...
  return (
    <>
      ...
      <aside
        ...
        } sm:translate-x-0 rounded-e-[15em]`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-blue-800 dark:bg-white-800">
          <span
            className="flex md:hidden 
          "
          >
            <button onClick={() => setOpenSidebar(false)} className="ms-auto ">
              <img src="/icons/closeSidebar.svg" className="w-5 " />
            </button>
          </span>
